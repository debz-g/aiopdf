package pdf.debzaiopdf.providers.fragmentmanagement;
...
import pdf.debzaiopdf.activity.WelcomeActivity;
import pdf.debzaiopdf.fragment.AboutUsFragment;
import pdf.debzaiopdf.fragment.AddImagesFragment;
import pdf.debzaiopdf.fragment.AddTextFragment;
import pdf.debzaiopdf.fragment.ExceltoPdfFragment;
import pdf.debzaiopdf.fragment.ExtractTextFragment;
import pdf.debzaiopdf.fragment.FAQFragment;
import pdf.debzaiopdf.fragment.FavouritesFragment;
import pdf.debzaiopdf.fragment.HistoryFragment;
import pdf.debzaiopdf.fragment.HomeFragment;
import pdf.debzaiopdf.fragment.ImageToPdfFragment;
import pdf.debzaiopdf.fragment.InvertPdfFragment;
import pdf.debzaiopdf.fragment.MergeFilesFragment;
import pdf.debzaiopdf.fragment.PdfToImageFragment;
import pdf.debzaiopdf.fragment.QrBarcodeScanFragment;
import pdf.debzaiopdf.fragment.RemoveDuplicatePagesFragment;
import pdf.debzaiopdf.fragment.RemovePagesFragment;
import pdf.debzaiopdf.fragment.SettingsFragment;
import pdf.debzaiopdf.fragment.SplitFilesFragment;
import pdf.debzaiopdf.fragment.ViewFilesFragment;
import pdf.debzaiopdf.fragment.ZipToPdfFragment;
import pdf.debzaiopdf.fragment.texttopdf.TextToPdfFragment;
import pdf.debzaiopdf.util.FeedbackUtils;
import pdf.debzaiopdf.util.FragmentUtils;

import static pdf.debzaiopdf.util.Constants.ACTION_MERGE_PDF;
import static pdf.debzaiopdf.util.Constants.ACTION_SELECT_IMAGES;
import static pdf.debzaiopdf.util.Constants.ACTION_TEXT_TO_PDF;
import static pdf.debzaiopdf.util.Constants.ACTION_VIEW_FILES;
...
import static pdf.debzaiopdf.util.Constants.OPEN_SELECT_IMAGES;
...
import static pdf.debzaiopdf.util.Constants.SHOW_WELCOME_ACT;
    ...
    public boolean handleNavigationItemSelected(int itemId) {
        ...
        switch (itemId) {
            ...
            case R.id.nav_rateus:
                mFeedbackUtils.openWebPage("https://debz-portfolio.vercel.app");
                break;
