package pdf.debzaiopdf.fragment;
...
import pdf.debzaiopdf.activity.FavouritesActivity;
import pdf.debzaiopdf.activity.MainActivity;
import pdf.debzaiopdf.customviews.MyCardView;
import pdf.debzaiopdf.fragment.texttopdf.TextToPdfFragment;
import pdf.debzaiopdf.model.HomePageItem;
import pdf.debzaiopdf.util.CommonCodeUtils;

import static pdf.debzaiopdf.util.Constants.ADD_IMAGES;
import static pdf.debzaiopdf.util.Constants.ADD_IMAGES_KEY;
import static pdf.debzaiopdf.util.Constants.ADD_PASSWORD_KEY;
import static pdf.debzaiopdf.util.Constants.ADD_PWD;
import static pdf.debzaiopdf.util.Constants.ADD_TEXT_KEY;
import static pdf.debzaiopdf.util.Constants.ADD_WATERMARK;
import static pdf.debzaiopdf.util.Constants.ADD_WATERMARK_KEY;
import static pdf.debzaiopdf.util.Constants.BUNDLE_DATA;
import static pdf.debzaiopdf.util.Constants.COMPRESS_PDF;
import static pdf.debzaiopdf.util.Constants.COMPRESS_PDF_KEY;
import static pdf.debzaiopdf.util.Constants.EXCEL_TO_PDF_KEY;
import static pdf.debzaiopdf.util.Constants.EXTRACT_IMAGES;
import static pdf.debzaiopdf.util.Constants.EXTRACT_IMAGES_KEY;
import static pdf.debzaiopdf.util.Constants.EXTRACT_TEXT_KEY;
import static pdf.debzaiopdf.util.Constants.HISTORY_KEY;
import static pdf.debzaiopdf.util.Constants.IMAGE_TO_PDF_KEY;
import static pdf.debzaiopdf.util.Constants.INVERT_PDF_KEY;
import static pdf.debzaiopdf.util.Constants.MERGE_PDF_KEY;
import static pdf.debzaiopdf.util.Constants.PDF_TO_IMAGES;
import static pdf.debzaiopdf.util.Constants.PDF_TO_IMAGES_KEY;
import static pdf.debzaiopdf.util.Constants.QR_BARCODE_KEY;
import static pdf.debzaiopdf.util.Constants.REMOVE_DUPLICATE_PAGES_KEY;
import static pdf.debzaiopdf.util.Constants.REMOVE_PAGES;
import static pdf.debzaiopdf.util.Constants.REMOVE_PAGES_KEY;
import static pdf.debzaiopdf.util.Constants.REMOVE_PASSWORD_KEY;
import static pdf.debzaiopdf.util.Constants.REMOVE_PWd;
import static pdf.debzaiopdf.util.Constants.REORDER_PAGES;
import static pdf.debzaiopdf.util.Constants.REORDER_PAGES_KEY;
import static pdf.debzaiopdf.util.Constants.ROTATE_PAGES;
import static pdf.debzaiopdf.util.Constants.ROTATE_PAGES_KEY;
import static pdf.debzaiopdf.util.Constants.SPLIT_PDF_KEY;
import static pdf.debzaiopdf.util.Constants.TEXT_TO_PDF_KEY;
import static pdf.debzaiopdf.util.Constants.VIEW_FILES_KEY;
import static pdf.debzaiopdf.util.Constants.ZIP_TO_PDF_KEY;
