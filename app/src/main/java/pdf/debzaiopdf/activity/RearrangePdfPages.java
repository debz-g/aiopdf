...
import pdf.debzaiopdf.adapter.RearrangePdfAdapter;
import pdf.debzaiopdf.util.Constants;
import pdf.debzaiopdf.util.DialogUtils;
import pdf.debzaiopdf.util.ThemeUtils;

import static pdf.debzaiopdf.util.Constants.CHOICE_REMOVE_IMAGE;
import static pdf.debzaiopdf.util.Constants.RESULT;
import static pdf.debzaiopdf.util.Constants.SAME_FILE;
