...
import static pdf.debzaiopdf.util.Constants.THEME_BLACK;
import static pdf.debzaiopdf.util.Constants.THEME_DARK;
import static pdf.debzaiopdf.util.Constants.THEME_WHITE;
